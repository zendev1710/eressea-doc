...
Man kann erkennen, dass Personen aus Einheit 32 hungern werden: 30 Silber reichen nicht für fünf Personen. Mit dem oben benutzten ECheck-Parameter -z -w4 wird ECheck dies aber bemerken und eine Warnung ausgeben. Die Einheit sollte also entweder Geld verdienen (z.B. mit [[bef-unterhalte]], sofern sie das Talent Unterhaltung schon beherrscht, sonst ggf. mit [[bef-arbeite]]) oder eine andere Einheit mit genug Silber sollte in die Region 5,3 ziehen.
