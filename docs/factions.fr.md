...
Les détails sont expliqués dans le chapitre sur la [[guerre]] dans la section sur [lignes de combat] et l'explication de l'ordre [[cmd-combat]].
...
Enfin, une unité peut être blessée lors d'un [[guerre|combat]] ou d'une [famine].  
Elle sera notée *[`exhausted`]* (épuisée), *`wounded`* (blessée), ou même *`badly wounded`* (gravement blessée).
...
Enfin, des alliés [trolls] transportent des gems (joyaux).  
En plus des [humains], [nains], et [trolls], il y a beaucoup d'autres races en Eressea.  
