...
- Il est impossible de placer une unité devant le propriétaire d'un bâtiment ou le capitaine d'un bateau. Utilisez l'ordre [`GIVE `*`unit-id`*` COMMAND`] à cet effet
...
Ainsi, les unités entrées dans une région par [MOVE] ou [RIDE] peuvent être triées immédiatement.

[Zugvorlage]: ./commands.md "Ordres"
[`GIVE `*`unit-id`*` COMMAND`]: ./cmd-give.md "GIVE"
[MOVE]: ./cmd-move.md "MOVE"
[RIDE]: ./cmd-ride.md "RIDE"
[a un impact]: ./tips-and-tricks#échapper-à-la-mort-par-famine
