...
- Dans [Compétence], K = maniement de catapulte, A = tir à l'arbalète, B = tir à l'arc, H = armes blanches, S = armes d'hast
- Toutes les armes en Mallorn ont une résistance magique de 15%, toutes les armes en laen et -stungen de 30% (les détails de résistance à la magie suivent plus loin)
- Une épée Flamboyante invoque également une petite boule de feu à chaque round de combat
...
Bien que les boucliers soient considérés comme des armures, ils peuvent être utilisés en complément d'une armure et avoir alors un effet additif sur celle-ci, mais un seul bouclier par personne.
