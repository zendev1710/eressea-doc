...
Es gibt noch andere Gegenstände außer Tränken, die benutzt werden können. Dazu gehören [Antimagiekristalle] und einige Parteigegenstände ([Weihnachtsgeschenke]). Diese können weitere Parameter haben, die in der Gegenstandsbeschreibung ([[bef-zeige]]) angegeben sind.
