...
- `TEMP`-Einheiten können nicht reservieren! Silber wie Gegenstände müssen ihnen mit [`GIVE`] übergeben werden.
- `RESERVE` kommt vor [GIVE][`GIVE`] und [RECRUIT] in der [Befehlsreihenfolge]. Also bezieht sich `JE` auf die Anzahl der Personen vor Personenübergabe und Rekrutierungen.
