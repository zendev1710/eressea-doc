...
In diesen Regeln gelten die folgenden Konventionen:
     ...
     GIVE einheit-nr [anzahl|ALLES] [gegenstand]
...
[WORK], [ATTACK], [STEAL], [RIDE], [FOLLOW], [RESEARCH], [BUY], [TEACH], [LEARN], [MAKE] (Ausnahme: MAKE TEMP), [MOVE], [PLANT], [PIRACY], [ROUTE], [SPY], [TAX], [ENTERTAIN], [SELL], [CAST], [DESTROY], [GROW].
