...
Abgerufen von „[https://wiki.eressea.de/index.php?title=Zauberbeschreibungen\_E2&oldid=9278]“
  ...
  [Amulett des wahren Sehens]: /index.php?title=Amulett_des_wahren_Sehens&action=edit&redlink=1 "Amulett des wahren Sehens (Seite nicht vorhanden)"
  [Flammenschwert]: /Flammenschwert "Flammenschwert"
  [Traumauge]: /index.php?title=Traumauge&action=edit&redlink=1 "Traumauge (Seite nicht vorhanden)"
  [Sphäre der Unsichtbarkeit]: /index.php?title=Sph%C3%A4re_der_Unsichtbarkeit&action=edit&redlink=1 "Sphäre der Unsichtbarkeit (Seite nicht vorhanden)"
  [Beutel des Negativen Gewichts]: /index.php?title=Beutel_des_Negativen_Gewichts&action=edit&redlink=1 "Beutel des Negativen Gewichts (Seite nicht vorhanden)"
  [Gürtel der Trollstärke]: /index.php?title=G%C3%BCrtel_der_Trollst%C3%A4rke&action=edit&redlink=1 "Gürtel der Trollstärke (Seite nicht vorhanden)"
  [Ring der Macht]: /index.php?title=Ring_der_Macht&action=edit&redlink=1 "Ring der Macht (Seite nicht vorhanden)"
  [Ring der Unsichtbarkeit]: /Ring_der_Unsichtbarkeit "Ring der Unsichtbarkeit"
