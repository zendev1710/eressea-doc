...
**`TEACH`**[<sup>`L`</sup>]` `*`einheit-nr`*`[`*`einheit-nr`*`]...`
...
Will man Einheiten fremder Parteien lehren, muss man von dieser Partei den Befehl [HELP] GUARD erhalten haben oder die zu lehrende Einheit muss mit [CONTACT] den Lehrer kontaktieren.
