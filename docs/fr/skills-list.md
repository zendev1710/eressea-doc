...
Voici la liste de toutes les compétences que les unités peuvent apprendre sur Eressea. Il ne s'agit là que d'un bref aperçu, les chapitres correspondants contiennent plus de détails.
...
Cela permet de lancer des sorts de combat et d'autres types de sorts. L'apprentissage de la magie coûte des [silver][magic] par personne et par tour, en fonction du niveau.
...
- Avec [`MAKE`][`MAKE SEEDS`]`[`*`quantité`*`] horse` on capture des chevaux présents dans la région, à raison d'un cheval par personne et par niveau de compétence en taming. Bien sûr, au maximum autant de chevaux que présents dans la région.
...
Fabrication d'armes en bois et en métal (voir [objets][objects]).
...
[tableau]: /Spezial:Meine_Sprache/Kampftabellen#Ausdauer "Kampftabellen"
...
[chevaux]: /Spezial:Meine_Sprache/Pferd_und_Wagen "Pferd und Wagen"
[`GROW HORSES`]: ./cmd-grow.md "GROW"
[stable]: /Spezial:Meine_Sprache/Pferdezucht "Pferdezucht"
[objects]: /Spezial:Meine_Sprache/Waren "Waren"
[bateaux]: ./ships.mde "Schiffe"
[`SPY`]: ./cmd-spy.md "SPIONIERE"
[2]: ./resources.md#ressources-minières "Ressources"
[routes]: /index.php?title=Sp%C3%A9cial:MyLanguage/Stra%C3%9Fen&action=edit&redlink=1 "Spécial:MyLanguage/Straßen (Seite nicht vorhanden)"
[tactics]: ./tactic.md "Taktik"
[rassemblement]: /index.php?title=Sp%C3%A9cial:MyLanguage/Musterung&action=edit&redlink=1 "Spécial:MyLanguage/Musterung (Seite nicht vorhanden)"
[voler]: ./camouflage.md "STEAL"
[vigilance]: ./cmd-guard.md "GUARD"
