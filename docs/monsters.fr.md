...
Ils peuvent (comme tous les monstres) attaquer les unités des joueurs.  
...
<!-- cspell:disable -->
*Shadow Demon (EN), Schattendämonen (DE)*.
<!-- cspell:enable -->

| Points de Vie | Attaque | Défense | Armure |
|:-------------:|:-------:|:-------:|:------:|
|      50       |    8    |   11    |   3    |

Les Démons de l'Ombre possèdent une résistance à la magie.  
...
<!-- cspell:disable -->
*Shadow Master (EN), Schattenmeister (DE)*.
<!-- cspell:enable -->
...
Ceux-ci n'existent que dans les anciens mondes, ou peut-être plus du tout.

### Seigneurs Squelettes
