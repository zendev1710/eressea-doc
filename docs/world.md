...
However, other region types (plain / forest, swamp, desert, highland) can also provide iron and / or stone with a certain probability.  
In these regions, however, the geologist may need to be a little more experienced, as the deposit does not necessarily have to be at mining level 1.  
For example, iron may start anywhere from mining level 1 to 7, while stone can be found at mining level 1 to 4 - provided the region has this resource.  
It is useful to know that a geologist always sees mining layers twice as deep as their skill value.  
For example, a level 3 miner can see any iron up to a maximum mining depth of layer 6.  
...
In addition to iron and stone, there is also the much rarer metal laen.  
