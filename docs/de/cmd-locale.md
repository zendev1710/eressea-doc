...
Zum andern ist er, wenn er von einer Einheit gegeben wird, ein Synonym von [`SPRACHE`]. Vorzugsweise sollte lieber jener Befehl gegeben werden.

<!-- From [https://wiki.eressea.de/index.php?title=LOCALE&oldid=6692] -->

[`SPRACHE`]: ./cmd-language.md "SPRACHE"
