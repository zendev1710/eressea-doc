...
| [`DEFAULT "Orders"`]                           | setzt Default-Befehl für die nächste Runde.  | [K]     |
...
| [`COMBAT REAR`]                                |                                              | [K]     |
| [`COMBAT NOT`]                                 |                                              | [K]     |
| [`COMBATSPELL [LEVEL n] "zauberspruch" [NOT]`] | setzt Zauber für Kämpfe                      | [K]     |
...
| [`PREFIX [präfix]`] | gibt der Rassenbezeichnung ein Präfix | [K] |
...
| [`SORT BEFORE <unit id>`] | Einheit in Report sortieren | [K] |
| [`SORT AFTER <unit id>`] |     | [K] |
| [`SPY <unit id>`] | Einheit ausspionieren | [L] |
| [`LANGUAGE en/de`] | ändert die Sprache der Partei | [K] |
| [`QUIT "passwort" [FACTION <faction id>]`] | aus dem Spiel ausscheiden | [K] |
...
[K]: ./commands.md#kurze-und-lange-befehle "Orders"
