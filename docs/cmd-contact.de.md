...
- `KONTAKTIERE` ist für manche Dinge erforderlich, die `HELFE GIB` oder `HELFE BEWACHE` nicht abdeckt, wie zum Beispiel [`GIB PERSONEN`][bef-gib] und manche Zauber.
