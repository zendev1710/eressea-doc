...
<!-- TODO: rename and move this page which mixes some characteristics, history, game variants... -->
...
Le jeu était à l'origine un spin-off d'une version **allemande** d'Atlantis 1.0. Seule la langue allemande était prise en charge.  
Depuis, il est possible de jouer à Eressea en **anglais**.  

## Déclinaisons du jeu

~Il y eut plusieurs ramifications directes sous le nom de Vinyambar.  
...
En juillet 2009, un nouveau monde de jeu avec des règles modifiées a été lancé, connu sous le nom d'Eressea 3 (E3 en abrégé).  
...
Il s'agissait d'un test destiné à montrer qu'il était possible de lancer de nouvelles factions dans d'anciennes régions, et ce dont ces factions avaient besoin pour démarrer afin de mener à bien leur tâche.  
