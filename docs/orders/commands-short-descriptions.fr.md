...
| [WORK](./cmd-work.md "WORK")                                                   | WORK                                         | earns 10 silver or more                           | L           |
| [ATTACK einheit-nr](./cmd-attack.md "ATTACK")                               | ATTACK unit-ID                               | attacks the unit                                  | (L)\*       |
...
| [PROMOTE](./cmd-promote.md "PROMOTE")                                        | PROMOTE                                      | Promote a unit to heroe                           | K           |
| [STEAL einheit-nr](./cmd-steal.md "STEAL")                                        | STEAL unit-ID                                | steal 50 Silver or more                           | L           |
...
| [NAME FREMDE UNIT einheit-nr "name"](./cmd-name.md "NAME")                  | NAME FOREIGN UNIT unit-no "name"             | names the specified foreign object                | K           |
| [NAME FREMDES SCHIFF schiff-nr "name"](./cmd-name.md "NAME")                   | NAME FOREIGN SHIP ship-no "name"             |                                                   | K           |
| [NAME FREMDES GEBÄUDE gebäude-nr "name"](./cmd-name.md "NAME")                 | NAME FOREIGN BUILDING building-no "name"     |                                                   | K           |
| [NAME FREMDE PARTEI partei-nr "name"](./cmd-name.md "NAME")                    | NAME FOREIGN FACTION faction-id "name"       |                                                   | K           |
...
| [ENTER GEBÄUDE gebäude-nr](./cmd-enter.md "ENTER")                                | ENTER BUILDING building-id                   | Enter a building                                  | K           |
| [ENTER SCHIFF schiff-nr](./cmd-enter.md "ENTER")                                  | ENTER SHIP ship-id                           | Enter a ship                                      | K           |
| [GUARD \[NOT\]](./cmd-guard.md "GUARD")                                         | GUARD                                        | guard the region                                  | K           |
| [BEZAHLE NOT \[gebäude-nr\]](./cmd-pay-not.md "BEZAHLE")                              | PAY \[NOT\]                                  | do not pay a maintenance                          | K           |
| [MESSAGE REGION "text"](./cmd-message.md "MESSAGE")                               | MESSAGE REGION "text"                        | Send a message                                    | K           |
| [MESSAGE SCHIFF schiff-nr "text"](./cmd-message.md "MESSAGE")                     | MESSAGE SHIP ship-id "text"                  | Send a message                                    | K           |
| [MESSAGE GEBÄUDE gebäude-nr "text"](./cmd-message.md "MESSAGE")                   | MESSAGE BUILDING building-id "text"          | Send a message                                    | K           |
| [MESSAGE UNIT einh-nr "text"](./cmd-message.md "MESSAGE")                      | MESSAGE UNIT unit-id "text"                  | Send a message                                    | K           |
| [MESSAGE PARTEI partei-nr "text"](./cmd-message.md "MESSAGE")                     | MESSAGE FACTION faction-id "text"            | Send a message                                    | K           |
| [DEFAULT befehl](./cmd-default.md "DEFAULT")                                            | DEFAULT                                      | sets the default order for the next turn          | K           |
| [UNIT einheit-nr](./cmd-unit.md "UNIT")                                        | UNIT unit-ID                                 | beginning of a unit's orders                      | K           |
| [EMAIL email@adresse](./cmd-email.md "EMAIL")                                           | EMAIL email@adresse                          | sets the e−mail the report is sent to             | K           |
| [END](./cmd-end.md "END")                                                            | END                                          | ends a MAKE TEMP block                            | K           |
| [ERESSEA partei-nr "passwort"](./cmd-eressea.md "ERESSEA")                              | ERESSEA faction-id "password"                | beginning of faction's orders                     | K           |
| [RIDE einheit-nr](./cmd-ride.md "RIDE")                                              | RIDE unit-id                                 | be transported by unit−id                         | L           |
| [FOLLOW UNIT einheit-nr](./cmd-follow.md "FOLLOW")                                      | FOLLOW UNIT unit-id                          | follows a unit                                    | (L)\*\*     |
| [FOLLOW SCHIFF schiff-nr](./cmd-follow.md "FOLLOW")                                        | FOLLOW SHIP ship-id                          | follows a ship                                    | (L)\*\*     |
| [RESEARCH KRÄUTER](./cmd-research.md "RESEARCH")                                           | RESEARCH herbs                               | search for herbs                                  | L           |
| [GIVE einheit-nr KRÄUTER](./cmd-give.md "GIVE")                                            | GIVE unit-id herbs                           | give a unit all herbs                             | K           |
| [GIVE einheit-nr KOMMANDO](./cmd-give.md "GIVE")                                           | GIVE unit-id command                         | give a unit ship/ building control                | K           |
| [GIVE einheit-nr UNIT](./cmd-give.md "GIVE")                                            | GIVE unit-id UNIT                            | give unit to a foreign faction                    | K           |
| [GIVE einheit-nr \[JE\] anzahl PERSONEN](./cmd-give.md "GIVE")                             | GIVE unit-id \[each\] amount MEN             | give a unit men                                   | K           |
| [GIVE einheit-nr \[JE\] anzahl SCHIFF](./cmd-give.md "GIVE")                               | GIVE unit-id \[each\] amount SHIP            | give SHIP to form convoys                         | K           |
| [GIVE einheit-nr \[JE\] anzahl SILBER](./cmd-give.md "GIVE")                               | GIVE unit-id \[each\] amount SILVER          | give silver                                       | K           |
| [GIVE einheit-nr \[JE\] anzahl gegenstand](./cmd-give.md "GIVE")                           | GIVE unit-id \[each\] amount item            | give item                                         | K           |
...
| [HELP partei-nr ALLES \[NOT\]](./cmd-help.md "HELP")                               | HELP faction-id ALL \[NOT\]                  | set up/revoke an unilateral alliance              | K           |
| [HELP partei-nr GIVE \[NOT\]](./cmd-help.md "HELP")                                 | HELP faction-id GIVE \[NOT\]                 |                                                   | K           |
| [HELP partei-nr COMBAT \[NOT\]](./cmd-help.md "HELP")                              | HELP faction-id COMBAT \[NOT\]               |                                                   | K           |
| [HELP partei-nr GUARD \[NOT\]](./cmd-help.md "HELP")                             | HELP faction-id GUARD \[NOT\]                |                                                   | K           |
| [HELP partei-nr SILBER \[NOT\]](./cmd-help.md "HELP")                              | HELP faction-id SILVER \[NOT\]               |                                                   | K           |
| [HELP partei-nr PARTEITARNUNG \[NOT\]](./cmd-help.md "HELP")                       | HELP faction-id FACTIONSTEALTH \[NOT\]       |                                                   | K           |
| [COMBAT](./cmd-combat.md "COMBAT")                                                 | COMBAT                                       | set the combat behaviour                          | K           |
...
| [CONTACT einheit-nr](./cmd-contact.md "CONTACT")                            | CONTACT unit-no                              | contact foreign unit                              | K           |
| [TEACH einheit-nr \[einheit-nr etc.\]](./cmd-teach.md "TEACH")                          | TEACH unit-no                                | teach units                                       | L           |
...
| [MAKE \[stufe\] gebäude-typ \[gebäude-nr\]](./cmd-make.md "MAKE")                    | MAKE \[level\] building-type \[building-ID\] | erect or extend a building                        | L           |
| [MAKE \[stufe\] SCHIFF \[schiff-nr\]](./cmd-make.md "MAKE")                          | MAKE \[level\] SHIP \[ship-ID\]              | extend a ship                                     | L           |
| [MAKE](./cmd-make.md "MAKE")                                                         | MAKE ??                                      | baue weiter an Gebäude/Schiff ??                  | L           |
...
| [NEXT](./cmd-next.md "NEXT")                                           | NEXT                                         | ends the orders of a faction                      | K           |
...
| [SORT BEFORE einheit-nr](./cmd-sort.md "SORT")                                 | SORT BEFORE unit-id                          | sort unit in report                               | K           |
| [SORT AFTER einheit-nr](./cmd-sort.md "SORT")                              | SORT AFTER unit-id                           |                                                   | K           |
| [SPY einheit-nr](./cmd-spy.md "SPY")                                  | SPY unit-id                                  | spy a unit                                        | L           |
| [LANGUAGE en/de](./cmd-language.md "LANGUAGE")                                             | LANGUAGE en/de                               | Change Language for orders                        | K           |
| [QUIT "passwort" \[PARTEI partei-nr\]](./cmd-quit.md "QUIT")                         | QUIT "password" \[FACTION Faction-id\]       | quit the game \[merge with another faction\]      | K           |
...
| [CARRY einheit-nr](./cmd-carry.md "CARRY")                      | CARRY unit-id                                | transport another unit                            | K           |
...
| [LEAVE](./cmd-leave.md "LEAVE")                                                | LEAVE                                        | leave ship or building                            | K           |
...
| [DESTROY](./cmd-destroy.md "DESTROY")                                           | DESTROY                                      | building, ship, or road                           | L           |
