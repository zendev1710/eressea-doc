...
Pour ce faire, elle a besoin d'une arme et de maîtriser la [compétence][liste-des-competences] correspondante, ainsi que de la compétence de [collecte des impôts][skill-taxation-fr-id].  
Jusqu'à **20 Silver** sont collectées auprès des agriculteurs par personne [armée et formée à l'arme portée][arme-et-pret-au-combat] et par niveau de compétence en matière de collecte des impôts.  
...
Si vous souhaitez empêcher les factions non alliées de collecter l'impôt, vous devrez donner l'ordre [`GUARD`][cmd-guard-fr].  
