...
Normale Zauber werden mit dem Befehl [CAST] gezaubert. Ihre Wirkung entfaltet sich entweder sofort (siehe [Befehlsreihenfolge]) oder manchmal auch erst zu einem späteren Zeitpunkt zum Beispiel zum Anfang der folgenden Runde.
...
Poursuivre la lecture : [Magiegebiete].
