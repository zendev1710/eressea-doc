...
| [[cmd-combat|`COMBAT`]]                                                                        | set the combat behavior                           | S           |
...
| [[cmd-default|`DEFAULT order`]]                                                                | sets the default order for the next turn          | S           |
...
| [[cmd-destroy|`DESTROY`]]                                                                      | building, ship, or road                           | L           |
| [[cmd-email|`EMAIL email@adresse`]]                                                            | sets the e−mail the report is sent to             | S           |
| [[cmd-end|`END`]]                                                                              | ends a MAKE TEMP block                            | S           |
...
| [[cmd-hide|`HIDE FACTION NUMBER nummer`]]                                                      | disguised as another faction                      | S           |
| [[cmd-hide|`HIDE FACTION`&nbsp;&#91;`NOT`&#93;]]                                               |                                                   | S           |
| [[cmd-hide|`HIDE race`]]                                                                       | Demon: disguise as another race                   | S           |
| [[cmd-hide|`HIDE`&nbsp;&#91;`level`&#93;]]                                                     | set hide level                                    | S           |
...
| [[cmd-leave|`LEAVE`]]                                                                          | leave ship or building                            | S           |
| [[cmd-locale|`LOCALE en/de`]]                                                                  | no function (only for tools)                      | S           |
| [[cmd-make|`MAKE`]]                                                                            | baue weiter an Gebäude/Schiff ??                  | L           |
...
| [[cmd-next|`NEXT`]]                                                                            | ends the orders of a faction                      | S           |
...
| [[cmd-promote|`PROMOTE`]]                                                                      | Promote a unit to hero                            | S           |
...
| [[cmd-work|`WORK`]]                                                                            | earns 10 silver or more                           | L           |
