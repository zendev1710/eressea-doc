...
The option of producing the end products directly on site can be worthwhile, as the end products are often lighter than the goods required for production. However, other additional conditions also make centralized further processing interesting.
