...
**`PLANT`**[<sup>`L`</sup>]`[`*`anzahl`*`] BÄUME`  
**`PLANT`**[<sup>`L`</sup>]`[`*`anzahl`*`] MALLORNSAMEN`  
**`PLANT`**[<sup>`L`</sup>]`[`*`anzahl`*`] SAMEN`
