...
Wenn eine Partei eine Region bewacht, gelten für Einheiten, die mit ihr nicht [[alliances|alliiert]] sind ([`HELP GUARD`] oder [[cmd-contact]]), folgende Einschränkungen:
