...
[les lignes de bataille dans le chapitre]: https://wiki.eressea.de/Schlacht "bataille"
[Sur la guerre]: https://wiki.eressea.de/Krieg "Guerre"
[`d’ATTAQUE`]: https://wiki.eressea.de/ATTACK "ATTAQUE"
[ Fuite]: https://wiki.eressea.de/Die_Flucht "L'évasion"
[GARDER]: https://wiki.eressea.de/BEWACHEN "GARDE"
[les commandes VERS]: https://wiki.eressea.de/MOVE "APRÈS"
[ITINÉRAIRE]: https://wiki.eressea.de/ROUTE "ITINÉRAIRE"
[SUIVRE]: https://wiki.eressea.de/FOLLOW "CONSÉQUENCE"
[les sorts de combat]: https://wiki.eressea.de/COMBATSPELL "SORTS DE COMBAT"
[`section AIDE`]: https://wiki.eressea.de/HELP "AIDE"
[Alliance]: https://wiki.eressea.de/Allianz "Allianz"
