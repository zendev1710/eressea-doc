...
With `DESCRIBE PRIVATE` you can give the ordered unit a "private" description that only the owner of the unit can see.  

Long descriptions must be done with the `\` (backslash) "extend order" separator.
