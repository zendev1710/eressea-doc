...
Um die benötigten Kräuter finden zu können, braucht man das Talent [Kräuterkunde][Alchemie].
...
\* Wirkt auf die Einheit, aber alle Dämonen der Partei in der Region bedienen sich davon, wenn etwas übrig ist.  
Es reicht also, eine Einheit (pro Region) damit zu bestücken, solange sie genug Bauernblut für alle Dämonen trinkt.

\*\* Der Trank wird auf eine andere Einheit mit dem Befehl `BENUTZE Dumpfbackenbrot abcd` angewandt.  
Hierbei ist zu beachten: Ist das Tarnungstalent des Anwenders kleiner oder gleich Wahrnehmung + 2 des Opfers, so geht die Anwendung fehl.  
