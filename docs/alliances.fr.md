...
Vous pouvez nouer des alliances avec d'autres factions non seulement « en esprit », mais aussi les formaliser grâce à l'ordre [[cmd-help-fr]].  
...
Cela équivaut à un [[cmd-contact-fr]] permanent pour [[cmd-give-fr]].  

!!! warning "Attention !"
    Pour transférer des personnes ou* des unités à une autre faction avec les ordres [`GIVE <leur-unité> <nombre> MEN`][cmd-give-fr] ou [`GIVE <leur-unité> UNIT`][cmd-give-fr], la faction destinataire doit donner l’ordre [[cmd-contact-fr]] !  
...
Lève toutes les restrictions de [[cmd-guard-fr]] et étend certaines fonctions utiles à la faction ciblée.  
