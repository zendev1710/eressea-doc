...
Abgerufen von „[https://wiki.eressea.de/index.php?title=Produktion&oldid=16875]“
...
- [Regeln]
  ...
  [Tränke]: /Tr%C3%A4nke "Tränke"
  [`MACHE `*`Anzahl`*` `*`Gegenstand`*]: /MACHE "MACHE"
  [1]: /Spezial:Meine_Sprache/Rohstoffe "Spezial:Meine Sprache/Rohstoffe"
  ...
  [https://wiki.eressea.de/index.php?title=Produktion&oldid=16875]: https://wiki.eressea.de/index.php?title=Produktion&oldid=16875
