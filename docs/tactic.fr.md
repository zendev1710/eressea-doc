...
Un tacticien qui [[cmd-combat|combat]] au premier rang reçoit un bonus de +1 à sa compétence de tactics.
...
Cela signifie que 12 tacticiens de niveau X atteignent en moyenne le même niveau qu'un tacticien de niveau X+2.
