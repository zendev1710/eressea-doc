...
Avec l4ORDRE `GROUP`, vous pouvez diviser la faction en sous-groupes qui ont un statut [`HELP`][cmd-help-fr] différent du reste de la faction.  
...
Vous pouvez également définir votre propre [préfixe][cmd-prefix-fr] pour chaque groupe.
