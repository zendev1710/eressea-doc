...
Einheit a darf Einheit x also die 1000 Silver übergeben. Falls x die einzige bewachende Einheit der Region ist, darf a auch rekrutieren und Steuern eintreiben. Einheit b von Partei ff darf nichts davon. Dafür müsste Einheit x den Befehl `CONTACT PARTEI ff` geben.
...
- `HELP` schließt `HELP SILVER, HELP COMBAT` und `HELP PARTEITARNUNG` ein.
