...
L'entrée réussit si l'unité propriétaire appartient à une autre faction mais a défini [`HELP GUARD`][cmd-help] pour la faction demandant l'entrée, ou si elle donne l'ordre [[cmd-contact]] pour l'unité requérante au même tour de jeu.  
