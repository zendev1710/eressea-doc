...
<!-- From [https://wiki.eressea.de/index.php?title=MACHE&oldid=16728] -->
  ...
  [Kräuterkunde]: /Kr%C3%A4uterkunde "Kräuterkunde"
  [Kräuter]: /Kr%C3%A4uter "Kräuter"
  [wieder einer Einheit der eigenen Partei zu]: /Parteien#Auflösung_von_Einheiten "Parteien"
  [Gebäude]: ./buildings.md "Gebäude"
  [Schiff]: /Schiffe "Schiffe"
  [Straßen]: /Stra%C3%9Fen "Straßen"
  [Straßenbau]: /Stra%C3%9Fenbau "Straßenbau"
  [Tunnel]: /Andere_Geb%C3%A4ude#Tunnel "Andere Gebäude"
  [Karawanserei]: /Andere_Geb%C3%A4ude#Karawanserei "Andere Gebäude"
  [Damm]: /Andere_Geb%C3%A4ude#Damm "Andere Gebäude"
