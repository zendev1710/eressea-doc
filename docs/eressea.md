...
Alle Vinyambar-Varianten waren zudem kostenpflichtig. Es gab auch mehrere Partien "High Speed Eressea" (HSE) bei denen in einer unabhängigen Instanz an einem Wochenende in einem Zeittakt von ca. 15 Minuten Auswertungen stattfanden. Im Juli 2009 wurde eine neue Spielwelt mit veränderten Regeln gestartet, bekannt als Eressea 3 oder kurz E3. Diese sollte als Test für neuere Versionen von Eressea dienen. Außerdem gab es ab April 2014 eine Partie für Patreon-Förderer unter dem Namen Deveron.
...
You can now also play it with English texts. Since December 2008, normal registrations were no longer possible, but the game continued to run.
