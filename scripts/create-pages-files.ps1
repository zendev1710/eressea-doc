...
$categories = @{
    ...
    'items' = @('adamantium', 'plate', 'alchemy', 'herbs', 'potions-and-herbs', 'amulet-of-true-sight', 'antimagic-crystal', 'belt-of-troll-strength', 'dream-eye', 'flaming-sword', 'iron-golem', 'magical-herb-bag', 'mountain-guard', 'ring-of-invisibility', 'ring-of-power', 'sack-of-holding', 'sphere-of-invisibility', 'stardust', 'stone-golem', 'solar-sail')
