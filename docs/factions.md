...
This first person is not special in any way; they are just the first person belonging to your new faction. You can [recruit][recruiting] new persons, and eventually produce [[items]], and build [[buildings]] and [[ships]], tame [horses][horse-and-carriage], forge [[war-tables|weapons]] and so on.
