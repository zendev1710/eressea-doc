...
Sinn des Parteipools ist es, dass du selbst entscheiden kannst, welche Einheit einen bestimmten Gegenstand verwenden soll.  
Gegenstände im Parteipool haben in den meisten Fällen besondere magische Kräfte.  
Mittels [`ZEIGE`][bef-zeige] erhältst Informationen darüber.  
Dies funktioniert auch, wenn der Gegenstand noch im Parteipool liegt.  
Diese Informationen sind jedoch oft nur vage und in der Regel musst du die Wirkung selbst erkunden.
