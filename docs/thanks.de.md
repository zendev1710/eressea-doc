...
Alexander Schröder hat das Spiel auf Deutsch übersetzt, abgeändert, und ein neues Regelwerk geschrieben. Für seine Version von Atlantis gelten dieselben Bedingungen. Der Sourcecode von Eressea war anfangs nicht frei erhältlich, er war Eigentum der Entwickler. Unter [Enno](https://wiki.eressea.de/index.php?title=Enno&action=edit&redlink=1) wurde der [Code](https://github.com/eressea/server/) später jedoch ebenfalls freigegeben.
