...
Such questions are independent of the tool used. Of course, links to (tool-specific) script collections are also helpful.
...
- [[optimize-learning-chains]] (A\*-Search, Backpack problem)
