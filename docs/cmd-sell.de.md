...
*`VERKAUFE` ist wie [[bef-kaufe]] ein ["pseudolanger" Befehl][kurze-und-lange-befehle].[^1]*
...
Im Normalreport taucht immer nur ein Befehl auf. Dies ist aber nur, damit nicht eine große Liste von Befehlen dort steht. Im Computerreport und der [Zugvorlage][befehl] sind alle `KAUFE`- und `VERKAUFE`-Befehle aufgeführt.
