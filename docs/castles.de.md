...
Ab welcher Größe eine Burg in eine neue Kategorie aufsteigt, steht in der Tabelle weiter unten. Je größer die Burg, um so schwieriger ist sie zu erweitern. Um an einer Burg weiterzubauen, braucht man mindestens das angegebene Talent Burgenbau. Eine Einheit kann Gesamttalent / Mindesttalent Steine pro Runde verbauen; du kannst also mit einer hinreichend guten Einheit und genug Steinen problemlos in einer Woche einen Turm bauen.
