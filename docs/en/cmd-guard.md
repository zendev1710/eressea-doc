...
<!-- From [https://wiki.eressea.de/index.php?title=BEWACHE&oldid=16839] -->
  ...
  [Waffe]: /Kriegstabellen#Waffeneigenschaften "Kriegstabellen"
  [bewaffnet]: /Bewaffnet "Bewaffnet"
  [alliiert]: /Allianz "Allianz"
  [`HELFE BEWACHE`]: /HELFE "HELFE"
  [`KONTAKTIERE`]: /KONTAKTIERE "KONTAKTIERE"
  [HANDELN]: /Geld#Handel "Geld"
  [`ARBEITEN`]: /ARBEITE "ARBEITE"
  [`UNTERHALTEN`]: /UNTERHALTE "UNTERHALTE"
  [`ATTACKIEREN`]: /ATTACKIERE "ATTACKIERE"
  [`VERLASSEN`]: /VERLASSE "VERLASSE"
  [Kampfende]: /Kampfende "Kampfende"
  [KÄMPFE FLIEHE]: /K%C3%84MPFE "KÄMPFE"
  [Monster]: /Monster "Monster"
  [ersten Wochen]: /Welpenschutz "Welpenschutz"
