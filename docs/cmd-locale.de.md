...
Zum andern ist er, wenn er von einer Einheit gegeben wird, ein Synonym von [`SPRACHE`][bef-sprache]. Vorzugsweise sollte lieber jener Befehl gegeben werden.

<!-- From [https://wiki.eressea.de/index.php?title=LOCALE&oldid=6692] -->

[bef-sprache]: [[bef-sprache]]
