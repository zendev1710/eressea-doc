...
- `RESERVIERE` kommt vor [GIB][`GIB`] und [REKRUTIERE] in der [Befehlsreihenfolge]. Also bezieht sich `JE` auf die Anzahl der Personen vor Personenübergabe und Rekrutierungen.
