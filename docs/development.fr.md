...
Les questions centrales ne peuvent souvent être résolues (presque) de manière optimale qu’en résolvant des problèmes d’optimisation complexes.  
Vous rencontrerez de nombreux problèmes d’optimisation fondamentaux.  
