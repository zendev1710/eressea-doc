...
La taille à partir de laquelle un château entre dans une nouvelle catégorie est indiquée dans le tableau ci-dessous.
...
Chaque semaine, l'unité agrandit le bâtiment de PP/(niveau de compétence requis) pierres. Les pierres nécessaires doivent également être disponibles.
...
Construction de châteaux - matériaux, niveau minimum en maçonnerie, bonus salaire, part du commerce et défense

| Type          | Taille min | Maçonnerie min | Bonus salaire | Part commerce | Bonus Déf. |
|---------------|-----------:|------------:|--------------:|--------------:|--------------:|
