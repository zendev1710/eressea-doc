...
The unit giving the order must own the item or have knowledge of the spell or potion.  
If an item is in the [[faction-pool]], any unit in the Party can give the `SHOW` order.  
