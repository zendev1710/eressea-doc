...
Before the battle, the best [[tactics|Tactician]] of all participating units is chosen.
...
**Attention!** If a ranged fighter gets into the front line (e.g. because it has been [overrun][combat rows]), they must defend themselves with a melee weapon.
