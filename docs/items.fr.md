...
Le total des niveaux de compétence est toujours divisé par le niveau de compétence requis pour la production de ces objets (voir [ces exemples][production]).  
...
| [Lance][lance]{title="Lance"}                                                |     2 | [fabrication d'armes][fabrication-darmes]{title="Weaponsmithing"}      |    2 |               2 bois |
