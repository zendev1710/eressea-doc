...
- Betreten von Gebäuden benötigt **HELP GUARD** oder **CONTACT** nicht mehr **HELP GIVE**.
...
- **LIEFERE** und **GIVE** können nun mit dem Parameter **ALLES** benutzt werden.
...
- Der Befehl **NUMBER \[Wunschid\]** wird eingeführt.
- Der Parameter **BAUERN** entfällt und wird durch **0** ersetzt, da GIVE BAUERN mit der Base36 Nummer baue verwechselt werden könnte.
...
- **FOLLOW** ist nur noch dann ein langer Befehl wenn sich die Einheit tatsächlich bewegt.
...
- Beim erstmaligem Lernen von Magie muss man sich nun mit LEARN MAGIE "Magiegebiet" für ein Gebiet entscheiden.
...
- Der Befehl **GROW KRÄUTER** wird eingeführt, alternativ funktioniert auch der Befehl **GROW BLUMEN**
...
- Die Befehle **LIEFERE**, **RESERVE** und **//** werden nun solange ausgeführt bis gegenteilige Befehle für eine Einheit eingehen. Hat der Spieler also beispielsweise einen NMR werden diese Befehle trotzdem ausgeführt.
...
- Einhergehend mit der Bauernglättung verloren Orks ihre Vermehrungsrate von 5%. Alle vorhandenen Ork Einheiten wurden in Snootlinge umgewandelt, diese können Kampfrelevante Talente nur noch bis t7 lernen. Orks werden seit der Änderung nur noch 1 zu 2 von den Bauern abgezogen beim Rekrutieren und 2 zu 1 an die Bauern übergeben, Snootlinge bringen keine Bauern bei der Übergabe an 0 (stimmt das so?). Die übergabe der alten Orks an die Bauern erfolgte in der Befehlsreihenfolge BEFORE der Bauernglättung um zu verhindern, dass sich Orks einen Vorteil erschummeln.  
...
- Katapultmunition wird eingeführt. Diese kann mittels MAKE KATAPULTMUNITION durch einen Steinbauer mit Talent 3 aus Steinen produziert werden und wiegt 10 Gewichtseinheiten. Eine Munitionseinheit entspricht dabei einer Salve von sechs Schüssen.
...
- Einheiten, die einen Chaoswirbel durchschreiten, verlieren 3/4 der Lebensenergie.
...
- Lange Befehle nach kurzen Kämpfen möglich; **MOVE**, **ROUTE** etc. nur, wenn keine der Einheiten aus der *Partei* einen langen Kampf hatte.
...
- Einheiten mit **COMBAT FLIEHE** können sich noch bewegen.
