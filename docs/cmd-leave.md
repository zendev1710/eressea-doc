...
If you use the [`ENTER`][cmd-enter] or [`MOVE`][cmd-move] orders, the units will sometimes automatically leave their ships and buildings.
...
For more information, see [`GUARD`][cmd-guard].  
