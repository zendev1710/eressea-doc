...
|----------------------------------------------------------------------------------------|----------------------------------------------|--------------------------------------------------------|-------------|
| [//](./cmd-comment-slash.md "KOMMENTAR")                                               | //                                           | bleibender Kommentar                                   | K           |
| [[bef-arbeite]](./cmd-work.md "ARBEITE")                                               | WORK                                         | verdient 10 Silber oder mehr                           | L           |
...
| [[bef-befoerdere]](./cmd-promote.md "BEFÖRDERE")                                       | PROMOTE                                      | macht Einheit zu Helden                                | K           |
...
| [[bef-ende]](./cmd-end.md "ENDE")                                                      | END                                          | beendet MACHE TEMP                                     | K           |
...
| [[bef-mache]](./cmd-make.md "MACHE")                                                   | MAKE                                         | baue weiter an Gebäude/Schiff                          | L           |
...
| [[bef-verlasse]](./cmd-leave.md "VERLASSE")                                            | LEAVE                                        | Schiff oder Gebäude verlassen                          | K           |
